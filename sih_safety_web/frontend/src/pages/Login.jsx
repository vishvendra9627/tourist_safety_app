...
function Auth() {
  ...
  const handleGoogleFailure = () => setError("Google Sign-In failed");
            ...
            {isSignUp ? (
              <>
                ...
                <p className="text-lg text-center">
                  Want me to help with Tourist Safety?  
                  Join us and start your journey with a smart & safe travel
                  experience.
                </p>
              </>
            ) : (
              <>
                ...
                <p className="text-lg text-center">
                  ...
                  Sign in to stay safe and explore with confidence.
                </p>
              </>
            )}
          </motion.div>
